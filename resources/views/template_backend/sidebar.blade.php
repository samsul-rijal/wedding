<div class="main-sidebar">
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a class="nav-link" href="{{ route('galeri-foto.index') }}"><i class="fas fa-camera"></i> <span>Galeri Foto</span></a></li>
        <li><a class="nav-link" href="{{ route('background-foto.index') }}"><i class="fas fa-image"></i> <span>Background Gambar</span></a></li>
        <li><a class="nav-link" href="{{ route('background-foto.index') }}"><i class="fas fa-map-marker-alt"></i> <span>Maps</span></a></li>
        <li><a class="nav-link" href="{{ route('musik.index') }}"><i class="fas fa-music"></i> <span>Musik</span></a></li>
