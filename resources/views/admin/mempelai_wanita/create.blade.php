...
@section('sub-judul','Tambah Mempelai Wanita')
@section('content')
    ...
    <form action="{{ route('mempelai-wanita.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
            <label>Putri</label>
            <select class="form-control" name="putri" aria-label="Default select example">
